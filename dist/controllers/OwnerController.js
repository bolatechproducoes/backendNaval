"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }// Importa o model Owner
...
class OwnerController {
  ...
  async index(req, res) {
    ...
    const owners = await _Owner2.default.findAll({
  ...
  async store(req, res) {
    try {
      ...
      const owner = await _Owner2.default.create(req.body);
  ...
  async show(req, res) {
    ...
    // Cria a constante id que recebe o id enviado na requisição
      ...
      const owner = await _Owner2.default.findByPk(id, {
        attributes: ['id', 'nome', 'sobrenome', 'telefone', 'email', 'user_id', 'club_id', 'boat_id'],
      // order: [['id', 'DESC'], [User, 'id', 'DESC'], [Boat, 'id', 'DESC'], [Club, 'id', 'DESC']],
      // include: {
      // model: [User, Boat, Club],
...
exports. default = new OwnerController();
